...
import { IconSearch } from '@kalidao/reality'
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.List ref={ref} className={cn(styles.commandList, className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group ref={ref} className={cn(styles.commandGroup, className)} {...props} />
))
