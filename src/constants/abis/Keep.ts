export const KEEP_ABI = [
  {
    inputs: [{ internalType: 'contract Keep', name: '_uriFetcher', type: 'address' }],
    stateMutability: 'payable',
    type: 'constructor',
  },
  { inputs: [], name: 'AlreadyInit', type: 'error' },
  { inputs: [], name: 'ExecuteFailed', type: 'error' },
  { inputs: [], name: 'ExpiredSig', type: 'error' },
  { inputs: [], name: 'InvalidRecipient', type: 'error' },
  { inputs: [], name: 'InvalidSig', type: 'error' },
  ...
  { inputs: [], name: 'QuorumOverSupply', type: 'error' },
  { inputs: [], name: 'Unauthorized', type: 'error' },
  { inputs: [], name: 'Undetermined', type: 'error' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'enum Operation', name: 'op', type: 'uint8' },
  ...
  },
  {
    ...
    name: 'checkpoints',
    outputs: [
      { internalType: 'uint40', name: 'fromTimestamp', type: 'uint40' },
      { internalType: 'uint216', name: 'votes', type: 'uint216' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
